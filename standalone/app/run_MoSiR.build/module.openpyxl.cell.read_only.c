...
static function_impl_code const function_table_openpyxl$cell$read_only[] = {
    impl_openpyxl$cell$read_only$$$function__1___init__,
    impl_openpyxl$cell$read_only$$$function__2___eq__,
    impl_openpyxl$cell$read_only$$$function__3___ne__,
    impl_openpyxl$cell$read_only$$$function__4___repr__,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_openpyxl$cell$read_only);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_openpyxl$cell$read_only,
        sizeof(function_table_openpyxl$cell$read_only) / sizeof(function_impl_code)
    );
}
