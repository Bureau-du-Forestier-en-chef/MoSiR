...
static PyObject *impl_werkzeug$user_agent$$$function__1___init__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_d0732437dd43c28b79684328a36fe31b = MAKE_FUNCTION_FRAME(tstate, codeobj_d0732437dd43c28b79684328a36fe31b, module_werkzeug$user_agent, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_d0732437dd43c28b79684328a36fe31b);
...
static PyObject *impl_werkzeug$user_agent$$$function__2___repr__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_4f46c5a06a8c06b83c5cdb60bc614847)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_4f46c5a06a8c06b83c5cdb60bc614847 = MAKE_FUNCTION_FRAME(tstate, codeobj_4f46c5a06a8c06b83c5cdb60bc614847, module_werkzeug$user_agent, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_4f46c5a06a8c06b83c5cdb60bc614847);
...
static PyObject *impl_werkzeug$user_agent$$$function__3___str__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_224d15a093ae708fc47da672eb121f7c)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_224d15a093ae708fc47da672eb121f7c = MAKE_FUNCTION_FRAME(tstate, codeobj_224d15a093ae708fc47da672eb121f7c, module_werkzeug$user_agent, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_224d15a093ae708fc47da672eb121f7c);
...
static PyObject *impl_werkzeug$user_agent$$$function__4___bool__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_98a19f1dbd8d86b5c1075a8c582c3ec3)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_98a19f1dbd8d86b5c1075a8c582c3ec3 = MAKE_FUNCTION_FRAME(tstate, codeobj_98a19f1dbd8d86b5c1075a8c582c3ec3, module_werkzeug$user_agent, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_98a19f1dbd8d86b5c1075a8c582c3ec3);
...
static PyObject *impl_werkzeug$user_agent$$$function__5_to_header(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_2044273c307672c80f228a3c2f4d013a)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_2044273c307672c80f228a3c2f4d013a = MAKE_FUNCTION_FRAME(tstate, codeobj_2044273c307672c80f228a3c2f4d013a, module_werkzeug$user_agent, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_2044273c307672c80f228a3c2f4d013a);
...
static function_impl_code const function_table_werkzeug$user_agent[] = {
    impl_werkzeug$user_agent$$$function__1___init__,
    impl_werkzeug$user_agent$$$function__2___repr__,
    impl_werkzeug$user_agent$$$function__3___str__,
    impl_werkzeug$user_agent$$$function__4___bool__,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_werkzeug$user_agent);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_werkzeug$user_agent,
        sizeof(function_table_werkzeug$user_agent) / sizeof(function_impl_code)
    );
}
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_6f8f4aca3350cdbb82a11556dd8a8875);
    ...
    // Tried code:
    {
        ...
        // Tried code:
        // Tried code:
        frame_ba785389f8376a475198594d3e32f37b_2 = MAKE_CLASS_FRAME(tstate, codeobj_ba785389f8376a475198594d3e32f37b, module_werkzeug$user_agent, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(tstate, frame_ba785389f8376a475198594d3e32f37b_2);
