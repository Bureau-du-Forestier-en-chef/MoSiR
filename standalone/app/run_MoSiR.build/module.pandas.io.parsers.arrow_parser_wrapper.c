...
static PyObject *impl_pandas$io$parsers$arrow_parser_wrapper$$$function__5_read(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_kw_call_dict_value_0_1 = impl___main__$$$function__2_complex_call_helper_star_dict(tstate, dir_call_args);
        }
...

        {
            ...
            tmp_kw_call_dict_value_1_1 = impl___main__$$$function__2_complex_call_helper_star_dict(tstate, dir_call_args);
        }
...

        {
            ...
            tmp_kw_call_dict_value_2_1 = impl___main__$$$function__2_complex_call_helper_star_dict(tstate, dir_call_args);
        }
