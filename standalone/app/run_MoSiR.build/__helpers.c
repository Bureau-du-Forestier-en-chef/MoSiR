...
PyObject *CALL_FUNCTION_WITH_ARGS25(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 25 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(tstate, function, args, 25);
        }
        ...
        if (method->m_object == NULL) {
            ...
            PyObject *result = Nuitka_CallFunctionPosArgs(tstate, method->m_function, args, 25);
            ...
            if (function->m_args_simple && 25 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(tstate, function, method->m_object, args, 25);
            }
...
#else
        PyObject *result = _PyFunction_Vectorcall(called, args, 25, NULL);
#endif
        CHECK_OBJECT_X(result);
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs(tstate, (struct Nuitka_FunctionObject const *)init_method, obj, args, 25);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS25(tstate, init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
