...
static function_impl_code const function_table_openpyxl$xml[] = {
    impl_openpyxl$xml$$$function__1_lxml_available,
    impl_openpyxl$xml$$$function__2_lxml_env_set,
    impl_openpyxl$xml$$$function__3_defusedxml_available,
    impl_openpyxl$xml$$$function__4_defusedxml_env_set,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_openpyxl$xml);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_openpyxl$xml,
        sizeof(function_table_openpyxl$xml) / sizeof(function_impl_code)
    );
}
