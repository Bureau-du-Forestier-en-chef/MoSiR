...
static function_impl_code const function_table_openpyxl$styles$fonts[] = {
    impl_openpyxl$styles$fonts$$$function__1__no_value,
    impl_openpyxl$styles$fonts$$$function__2___init__,
    impl_openpyxl$styles$fonts$$$function__3_from_tree,
    NULL
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_openpyxl$styles$fonts);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_openpyxl$styles$fonts,
        sizeof(function_table_openpyxl$styles$fonts) / sizeof(function_impl_code)
    );
}
