...
static function_impl_code const function_table_openpyxl$utils$cell[] = {
    impl_openpyxl$utils$cell$$$function__1_get_column_interval,
    impl_openpyxl$utils$cell$$$function__2_coordinate_from_string,
    impl_openpyxl$utils$cell$$$function__3_absolute_coordinate,
    impl_openpyxl$utils$cell$$$function__4__get_column_letter,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_openpyxl$utils$cell);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_openpyxl$utils$cell,
        sizeof(function_table_openpyxl$utils$cell) / sizeof(function_impl_code)
    );
}
