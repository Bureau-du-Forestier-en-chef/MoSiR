...
static PyObject *impl_flask$json$$$function__1_dumps(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_09c8d9aa9c6498f4c88283c997381bf3 = MAKE_FUNCTION_FRAME(tstate, codeobj_09c8d9aa9c6498f4c88283c997381bf3, module_flask$json, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_09c8d9aa9c6498f4c88283c997381bf3);
...
static PyObject *impl_flask$json$$$function__2_dump(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_bd2bd7a194890bdeccc487a0b2145bbd)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_bd2bd7a194890bdeccc487a0b2145bbd = MAKE_FUNCTION_FRAME(tstate, codeobj_bd2bd7a194890bdeccc487a0b2145bbd, module_flask$json, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_bd2bd7a194890bdeccc487a0b2145bbd);
...
static PyObject *impl_flask$json$$$function__3_loads(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_4f1ddcb32dcfd978a68f26e2754b2f28)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_4f1ddcb32dcfd978a68f26e2754b2f28 = MAKE_FUNCTION_FRAME(tstate, codeobj_4f1ddcb32dcfd978a68f26e2754b2f28, module_flask$json, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_4f1ddcb32dcfd978a68f26e2754b2f28);
...
static PyObject *impl_flask$json$$$function__4_load(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_2f3c05dddbbfea2aebb4d4369f1a75e8)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_2f3c05dddbbfea2aebb4d4369f1a75e8 = MAKE_FUNCTION_FRAME(tstate, codeobj_2f3c05dddbbfea2aebb4d4369f1a75e8, module_flask$json, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_2f3c05dddbbfea2aebb4d4369f1a75e8);
...
static PyObject *impl_flask$json$$$function__5_jsonify(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_137ae146da30b2286851776844884c5d)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_137ae146da30b2286851776844884c5d = MAKE_FUNCTION_FRAME(tstate, codeobj_137ae146da30b2286851776844884c5d, module_flask$json, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_137ae146da30b2286851776844884c5d);
...
static function_impl_code const function_table_flask$json[] = {
    impl_flask$json$$$function__1_dumps,
    impl_flask$json$$$function__2_dump,
    impl_flask$json$$$function__3_loads,
    impl_flask$json$$$function__4_load,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_flask$json);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_flask$json,
        sizeof(function_table_flask$json) / sizeof(function_impl_code)
    );
}
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_cab9941638b9ee9f464c41b3983fcc4c);
