...
static PyObject *impl_pandas$core$arraylike$$$function__32_array_ufunc(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_7 = impl___main__$$$function__2_complex_call_helper_star_dict(tstate, dir_call_args);
        }
    ...
    branch_yes_8:;
    {
...

        {
            ...
            tmp_assign_source_56 = impl___main__$$$function__7_complex_call_helper_pos_star_list_star_dict(tstate, dir_call_args);
        }
    ...
    branch_yes_9:;
    {
...

        {
            ...
            tmp_assign_source_57 = impl___main__$$$function__7_complex_call_helper_pos_star_list_star_dict(tstate, dir_call_args);
        }
    ...
    branch_no_13:;
    {
...

        {
            ...
            tmp_assign_source_66 = impl___main__$$$function__7_complex_call_helper_pos_star_list_star_dict(tstate, dir_call_args);
        }
...
static PyObject *pandas$core$arraylike$$$function__32_array_ufunc$$$genexpr__2_genexpr_context(PyThreadState *tstate, struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
...

    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1};
            tmp_expression_value_1 = impl___main__$$$function__2_complex_call_helper_star_dict(tstate, dir_call_args);
        }
        if (tmp_expression_value_1 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
