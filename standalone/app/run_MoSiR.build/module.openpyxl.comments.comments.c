...
static function_impl_code const function_table_openpyxl$comments$comments[] = {
    impl_openpyxl$comments$comments$$$function__1___init__,
    impl_openpyxl$comments$comments$$$function__2_parent,
    impl_openpyxl$comments$comments$$$function__3___eq__,
    impl_openpyxl$comments$comments$$$function__4___repr__,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_openpyxl$comments$comments);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_openpyxl$comments$comments,
        sizeof(function_table_openpyxl$comments$comments) / sizeof(function_impl_code)
    );
}
