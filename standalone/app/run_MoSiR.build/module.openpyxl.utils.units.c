...
static function_impl_code const function_table_openpyxl$utils$units[] = {
    impl_openpyxl$utils$units$$$function__1_inch_to_dxa,
    impl_openpyxl$utils$units$$$function__2_dxa_to_inch,
    impl_openpyxl$utils$units$$$function__3_dxa_to_cm,
    impl_openpyxl$utils$units$$$function__4_cm_to_dxa,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_openpyxl$utils$units);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_openpyxl$utils$units,
        sizeof(function_table_openpyxl$utils$units) / sizeof(function_impl_code)
    );
}
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        frame_8878566b3419f98275cb3a408b87ce5e->m_frame.f_lineno = 4;
