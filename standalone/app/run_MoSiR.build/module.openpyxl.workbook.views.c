...
static function_impl_code const function_table_openpyxl$workbook$views[] = {
    impl_openpyxl$workbook$views$$$function__1___init__,
    impl_openpyxl$workbook$views$$$function__2___init__,
    NULL
};
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_openpyxl$workbook$views);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_openpyxl$workbook$views,
        sizeof(function_table_openpyxl$workbook$views) / sizeof(function_impl_code)
    );
}
