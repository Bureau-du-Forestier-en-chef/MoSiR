...
static function_impl_code const function_table_openpyxl$worksheet$header_footer[] = {
    impl_openpyxl$worksheet$header_footer$$$function__7___str__$$$function__1_replace,
    impl_openpyxl$worksheet$header_footer$$$function__1__split_string,
    impl_openpyxl$worksheet$header_footer$$$function__2___init__,
    impl_openpyxl$worksheet$header_footer$$$function__3___str__,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_openpyxl$worksheet$header_footer);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_openpyxl$worksheet$header_footer,
        sizeof(function_table_openpyxl$worksheet$header_footer) / sizeof(function_impl_code)
    );
}
