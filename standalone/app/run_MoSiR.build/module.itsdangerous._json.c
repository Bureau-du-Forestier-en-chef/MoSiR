...
static PyObject *impl_itsdangerous$_json$$$function__1_loads(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_46c9015860dd2cfcc318e52c2e4f27c7 = MAKE_FUNCTION_FRAME(tstate, codeobj_46c9015860dd2cfcc318e52c2e4f27c7, module_itsdangerous$_json, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_46c9015860dd2cfcc318e52c2e4f27c7);
...
static PyObject *impl_itsdangerous$_json$$$function__2_dumps(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_b375dbd67affa318e901733cb51e79ee)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_b375dbd67affa318e901733cb51e79ee = MAKE_FUNCTION_FRAME(tstate, codeobj_b375dbd67affa318e901733cb51e79ee, module_itsdangerous$_json, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_b375dbd67affa318e901733cb51e79ee);
...
static function_impl_code const function_table_itsdangerous$_json[] = {
    impl_itsdangerous$_json$$$function__1_loads,
    impl_itsdangerous$_json$$$function__2_dumps,
    NULL
};
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_itsdangerous$_json);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_itsdangerous$_json,
        sizeof(function_table_itsdangerous$_json) / sizeof(function_impl_code)
    );
}
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_47f1ef06bb5bdacaf427436bd8ef296c);
    ...
    // Tried code:
    {
        ...
        // Tried code:
        // Tried code:
        frame_ee92b03c54a0aed0b345f14bce440b74_2 = MAKE_CLASS_FRAME(tstate, codeobj_ee92b03c54a0aed0b345f14bce440b74, module_itsdangerous$_json, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(tstate, frame_ee92b03c54a0aed0b345f14bce440b74_2);
