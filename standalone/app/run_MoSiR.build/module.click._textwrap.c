...
static PyObject *impl_click$_textwrap$$$function__1__handle_long_word(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_945edc3204a20bc5fe756714c348cb8f = MAKE_FUNCTION_FRAME(tstate, codeobj_945edc3204a20bc5fe756714c348cb8f, module_click$_textwrap, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_945edc3204a20bc5fe756714c348cb8f);
...
static PyObject *click$_textwrap$$$function__2_extra_indent$$$genobj__1_extra_indent_context(PyThreadState *tstate, struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(tstate, codeobj_4774398c744fcbfdfd8cee55be78d1ca, module_click$_textwrap, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
...
static PyObject *impl_click$_textwrap$$$function__3_indent_only(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_e54af58c731b2369e2b36e597b92a9a9)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_e54af58c731b2369e2b36e597b92a9a9 = MAKE_FUNCTION_FRAME(tstate, codeobj_e54af58c731b2369e2b36e597b92a9a9, module_click$_textwrap, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_e54af58c731b2369e2b36e597b92a9a9);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_90e4b72f95903b06fb20c78fd4f26dc9);
    ...
    branch_end_1:;
    {
        ...
        frame_bbe4d0761f71252e467fe069edad34e4_2 = MAKE_CLASS_FRAME(tstate, codeobj_bbe4d0761f71252e467fe069edad34e4, module_click$_textwrap, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(tstate, frame_bbe4d0761f71252e467fe069edad34e4_2);
